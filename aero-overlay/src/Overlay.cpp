...
Overlay::Overlay()
{
    m_ClassName.assign( "TEST" );
    m_WindowTitle.assign( "TEST" );
}
    ...
    const std::string& target_window_title )
{
    ...
    SetLayeredWindowAttributes(m_WndOverlay, 0, 1.0f, LWA_ALPHA);
    SetLayeredWindowAttributes(m_WndOverlay, 0, RGB(0, 0, 0), LWA_COLORKEY);
